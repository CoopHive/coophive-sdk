...
[coophive-sdk](../globals.md) / clientToProvider

# Function: clientToProvider()

> **clientToProvider**(`publicClient`): `undefined` \| `JsonRpcProvider` \| `FallbackProvider`

## Parameters

• **publicClient**

• **publicClient.account**: `undefined`
...
• **publicClient.batch.multicall?**: `boolean` \| `object`

Toggle to enable `eth_call` multicall aggregation.

• **publicClient.cacheTime**: `number`
...
• **publicClient.ccipRead?**: `false` \| `object`

[CCIP Read](https://eips.ethereum.org/EIPS/eip-3668) configuration.

• **publicClient.chain**: `undefined` \| `Chain`
...
• **publicClient.name**: `string`

A name for the client.

• **publicClient.pollingInterval**: `number`
...
• **publicClient.request**: `EIP1193RequestFn`\<`PublicRpcSchema`\>
...
• **publicClient.transport**: `TransportConfig`\<`string`, `EIP1193RequestFn`\> & `Record`\<`string`, `any`\>

The RPC transport

• **publicClient.type**: `string`

The type of client.

• **publicClient.uid**: `string`
...
[src/utils.ts:39](https://github.com/CoopHive/coophive-sdk/blob/0566794b0d4e977b07da040496c8b6dca5eb89e3/src/utils.ts#L39)
